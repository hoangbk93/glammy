      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            @endif
            <form role="form" method="post" action=" {{ url('admin/user/add') }}"> {{ csrf_field() }}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter account" name="user">
                </div>
                <div class="form-group">
